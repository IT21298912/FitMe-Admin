...
import com.example.fitmeadmin.Activity.SignIn
...
class HomeFragment : Fragment() {
    ...
    private  lateinit var trainer:Button
    private  lateinit var userB:Button
    override fun onCreateView(
        ...
        trainer=view.findViewById(R.id.btnBookTrainer)
        userB=view.findViewById(R.id.btnBookTrainer2)


        trainer.setOnClickListener {
            val intent = Intent(requireActivity(), Trainers::class.java)
            startActivity(intent)
        }
        userB.setOnClickListener {
//            val intent = Intent(requireActivity(), UsersFragment::class.java)
//            startActivity(intent)
        }
